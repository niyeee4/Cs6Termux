...
- [Termux:X11-Extra](https://github.com/moio9/termux-x11-extra/releases/download/v0.11.1/app-universal-debug.apk)
## 🚀 Recommended specs (Snapdragon only):
- Snapdragon 8 Gen 1 or newer
- 8 GB RAM or more
- At least 10 GB free storage
> Devices below Snapdragon 8 Gen 1 may still work.
# Installation
